(function(){
  ...
  Tetris.ParticleEffects.prototype.addBlockExplosions = function(blocks){
    this.removeBlockEmitters();
    this.initExplodeConfig();

    for(var i = 0; i < blocks.length; i++){
      this.addBlockExplosion(blocks[i]); // Добавить взрыв для каждого блока
  }
  };
  Tetris.ParticleEffects.prototype.addBlockExplosion = function(block, e){    
    var px = block.x * Tetris.TILESIZE;
    var py = block.y * Tetris.TILESIZE;
