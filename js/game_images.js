(function(){
	...
	Tetris.Game.prototype.loadImages = function(){
		...
		var blocks = Array.apply(null, Array(8)).map(function() { return new Image() });
			...
			blocks[i].onload = (function(e) {
				switch ($(e.target).attr('src')){
					...
					case "images/block-t.png":
						...
						break;
					case "images/block-super.png":
						Tetris.SuperBlocks = Tetris.initTiles(e.target);
						break;
				}
  		}).bind(this);
		}
  	...
  	mainImg.onload = (function(){
		...
		blocks[7].src = "images/block-super.png"
